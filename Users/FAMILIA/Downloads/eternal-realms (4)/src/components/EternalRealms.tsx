    ...
    <>
      ...
      <div className="fixed z-20 flex flex-col gap-2" style={{ top: 220, left: 8 }}>
        ...
        <button
          ...
          className="text-[11px] font-mono font-bold tracking-widest px-3 py-1.5 border border-cyan-600/60 bg-black/80 text-cyan-200 hover:bg-cyan-900/30 text-left"
            ...
            <div className="w-full md:w-[280px] bg-neutral-900/95 border border-amber-700/40 p-4 rounded flex flex-col justify-between max-h-[540px] overflow-auto">
              ...
              <div className="mt-4 pt-3 border-t border-amber-700/30 flex flex-col gap-2">
                <button
                  ...
                  className="w-full text-[10px] py-2 border border-red-600/50 bg-red-950/30 text-red-200 hover:bg-red-900/60 tracking-widest text-center font-bold"
                >
                  🔄 REINICIAR ARVORE (RESPEC)
                </button>
                <button
                  onClick={() => setShowTalents(false)}
                  className="w-full text-[10px] py-2 border border-amber-600/50 bg-amber-950/60 text-amber-200 hover:bg-amber-800/60 tracking-widest text-center font-bold"
                >
                  FECHAR CODEX
                </button>
              </div>
