...
export default function RucoySideBar({ playerLevel }: Props) {
  ...
  return (
    <>
      ...
      {/* Modals */}
      {open && (
        <ModalShell title={BUTTONS.find((b) => b.id === open)!.label} onClose={() => setOpen(null)}>
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full sm:max-w-sm flex flex-col overflow-hidden animate-in slide-in-from-bottom-8 sm:zoom-in-95 duration-300"
        style={{
          maxHeight: "65vh",
